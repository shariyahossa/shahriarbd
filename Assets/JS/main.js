...
// We validate if the user previously those a topic 
if (selectedTheme) {
    // If the validation is fulfilled, we ask what the issue was the know if we activated or deactivated the dark
...
sr.reveal(`.about__container`, {delay: 900});
